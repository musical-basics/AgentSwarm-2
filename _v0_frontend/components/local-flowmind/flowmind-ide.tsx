                        ...
                        {swarmTab === "topology" ? (
                          ...
                          <div className="p-4 space-y-6 overflow-auto h-full">
                            <div className="space-y-4">
                              <h3 className="text-[10px] font-bold text-[#22d3ee] uppercase tracking-[0.2em] flex items-center gap-2">
                                <Shield className="w-3 h-3" /> Budget Optimization
                              </h3>
                              <div className="space-y-2">
                                <div className="flex justify-between items-center px-1">
                                  <span className="text-[9px] text-[#808080] uppercase tracking-widest">Max Token Budget ($)</span>
                            ...
                            <div className="space-y-4 pt-4 border-t border-white/5">
                              ...
                              <select 
                                ...
                                className="w-full bg-[#12121a]/80 border border-[#a855f7]/30 rounded px-3 py-2 text-[10px] text-white outline-none"
                              >
                                <option value="openai/gpt-4o">GPT-4o (Swift/Pro)</option>
